...
export const ProposalController = {
  ...
  async update(req: Request, res: Response) {
    try {
      const { id, ownerId, imageUrl, video, name, category, summary, description, targetPrice, starTime, endTime, ageLimit, customizedUrl, status} =  req.body 
      const userProposal = { ownerId,imageUrl,video, name, category, summary, description, targetPrice, starTime, endTime, ageLimit, customizedUrl, status }
      // 募資活動網址重複
